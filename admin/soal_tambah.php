            ...
            <div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
									<form method="post" action="tambah_aksi_soal.php" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      <div class="form-group row">
											<label class="col-form-label col-md-3 col-sm-3 label-align ">Soal <span class="required">*</span>
											</label>
											<div class="col-md-9 col-sm-9 ">
												<textarea class="form-control" rows="7" name="soal"></textarea>
											</div>
										</div>
                      <div class="form-group row">
											...
											<div class="col-md-9 col-sm-9 ">
												<textarea class="form-control" rows="2" name="pil_a" ></textarea>
											</div>
										</div>
                      <div class="form-group row">
											...
											<div class="col-md-9 col-sm-9 ">
												<textarea class="form-control" rows="2" name="pil_b"></textarea>
											</div>
										</div>
                      <div class="form-group row">
											...
											<div class="col-md-9 col-sm-9 ">
												<textarea class="form-control" rows="2" name="pil_c"></textarea>
											</div>
										</div>
                      <div class="form-group row">
											...
											<div class="col-md-9 col-sm-9 ">
												<textarea class="form-control" rows="2" name="pil_d"></textarea>
											</div>
										</div>
                      <div class="form-group row">
											...
											<div class="col-md-9 col-sm-9 ">
												<textarea class="form-control" rows="2" name="pil_e"></textarea>
											</div>
										</div>
                    <div class="form-group row">
                    ...
                    <div class="item form-group">
                      <label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">Jawaban <span class="required">*</span>
											</label>
											<div class="col-md-6 col-sm-6 ">
												<select class="form-control" name="kunci">
													<option>--Pilih Kunci Jawaban--</option>
													<option value="pil_a">A</option>
                          <option value="pil_b">B</option>
                          <option value="pil_c">C</option>
                          <option value="pil_d">D</option>
                          <option value="pil_e">E</option>
												</select>
											</div>
										</div>
