            ...
            <div class="row">
								...
								<div class="x_content">
									<br />
                                        <?php
                                            include '../koneksi.php';
                                            $id = $_GET['id'];
                                            $hasil=mysqli_query($koneksi,"select * from ujian, pelajaran where ujian.id_pel=pelajaran.id_pel and id_ujian='$id'");
                                            while($ue = mysqli_fetch_array($hasil)){
                                        ?>
					                    <form method="post" action="edit_aksi_ujian.php" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      <div class="form-group row">
                        ...
                        <select class="form-control" name="id_pel">
                            <?php
                            echo "<option value=$ue[id_pel]> $ue[nama_pel] </option>";
                            ...
                            ?>
                                        ...
                                        <div class="form-group row">
											<label class="col-form-label col-md-3 col-sm-3 label-align ">Judul Ujian <span class="required">*</span>
											</label>
											<div class="col-md-9 col-sm-9 ">
                                                <input type="text" name="judul_ujian" id="first-name" required="required" value="<?php echo $ue['judul_ujian']; ?>" class="form-control ">
											</div>
										</div>
                                        <div class="form-group row">
											...
											<div class="col-md-9 col-sm-9 ">
												<textarea class="form-control" rows="2" name="deskripsi"><?php echo $ue['deskripsi']; ?></textarea>
											</div>
										</div>
                                        <div class="form-group row">
											<label class="col-form-label col-md-3 col-sm-3 label-align ">Time Limit <span class="required">*</span>
											</label>
											<div class="col-md-9 col-sm-9 ">
                                                <input type="text" name="time_limit" id="first-name" required="required" value="<?php echo $ue['time_limit']; ?>" class="form-control ">
										...
										<div class="item form-group">
											<div class="col-md-6 col-sm-6 offset-md-3">
												...
												<a href="ujian.php"><button class="btn btn-primary" type="button">Cancel</button></a>
											</div>
										</div>
