          ...
          <div class="">
              ...
              <div class="title_right">
                <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
                  <div class="input-group">
                    <a href="soal_tambah.php"><button class="fa fa-plus-square-o btn btn-primary float-right" type="button"> Tambah</button></a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Default Example <small>Soal</small></h2>
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                      <thead>
                        ...
                        include '../koneksi.php';
                        $no = 1;
                        $data = mysqli_query($koneksi,"select * from soal, pelajaran where soal.id_pel = pelajaran.id_pel");
		                    while($sl = mysqli_fetch_array($data)){
                        ?>
                      </thead>
                      <tbody>
                        <tr>
                          <td><?php echo $no++; ?></td>
                          <td><?php echo substr($sl['soal'], 0, 10)?></td>
                          <td><?php echo $sl['pil_a']?></td>
                          <td><?php echo $sl['pil_b']?></td>
                          <td><?php echo $sl['pil_c']?></td>
                          <td><?php echo $sl['pil_d']?></td>
                          <td><?php echo $sl['pil_e']?></td>
                          <td><?php echo $sl['nama_pel']?></td>
                          <td class="text-center">
                            <a href="soal_detail.php?id=<?php echo $sl['id_soal']; ?>" class="fa fa-exclamation-circle">Detail</a>
                            ||
                            <a href="soal_edit.php?id=<?php echo $sl['id_soal']; ?>" class="fa fa-pencil-square-o">Edit</a>
                            ||
                            <a href="delete_aksi_soal.php?id=<?php echo $sl['id_soal']; ?>" class="fa fa-trash">Hapus</a>
                          </td>
                        </tr>
                        <?php
                        }
