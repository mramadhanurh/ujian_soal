              ...
              <div class="title_right">
                <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
                  <div class="input-group">
                    <a href="ujian_tambah.php"><button class="fa fa-plus-square-o btn btn-primary float-right" type="button"> Tambah</button></a>
                  </div>
                </div>
              </div>
            </div>
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                      <thead>
                        ...
                        include '../koneksi.php';
                        $no = 1;
                        $data = mysqli_query($koneksi,"select * from ujian, pelajaran where ujian.id_pel = pelajaran.id_pel");
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td><?php echo $sl['judul_ujian']?></td>
                          <td><?php echo $sl['deskripsi']?></td>
                          <td><?php echo $sl['time_limit']?></td>
                          <td class="text-center">
                            <a href="ujian_edit.php?id=<?php echo $sl['id_ujian']; ?>" class="fa fa-pencil-square-o">Edit</a>
                            ||
                            <a href="delete_aksi_ujian.php?id=<?php echo $sl['id_ujian']; ?>" class="fa fa-trash">Hapus</a>
                          </td>
                        </tr>
                        <?php
                        }
