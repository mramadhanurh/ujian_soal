            ...
            <div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
									<form method="post" action="tambah_aksi_ujian.php" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                        ...
                        <select class="form-control" name="id_pel">
                            ...
                            ?>
                                        ...
                                        <div class="form-group row">
											...
											<div class="col-md-9 col-sm-9 ">
												<textarea class="form-control" rows="2" name="judul_ujian" ></textarea>
											</div>
										</div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
											...
											<div class="col-md-9 col-sm-9 ">
												<textarea class="form-control" rows="2" name="time_limit"></textarea>
											</div>
										</div>
