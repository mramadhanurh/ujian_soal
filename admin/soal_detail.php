							...
							<div class="x_panel">
								...
								<div class="x_content">
                                    ...
                                    <?php
                                        include '../koneksi.php';
                                        $id = $_GET['id'];
                                        $hasil=mysqli_query($koneksi,"select * from soal where id_soal='$id'");
									...
									<form method="post" action="" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                                        <div class="form-group row">
											...
											<div class="col-md-9 col-sm-9 ">
                                                <input type="hidden" name="" value="<?php echo $sl['id_soal']; ?>">
												<textarea class="form-control" rows="7" readonly="readonly"><?php echo $sl['soal']; ?></textarea>
											</div>
										</div>
                                        <div class="form-group row">
											...
											<div class="col-md-9 col-sm-9 ">
												<textarea class="form-control" rows="2" readonly="readonly"><?php echo $sl['pil_a']; ?></textarea>
											</div>
										</div>
                                        <div class="form-group row">
											...
											<div class="col-md-9 col-sm-9 ">
												<textarea class="form-control" rows="2" readonly="readonly"><?php echo $sl['pil_b']; ?></textarea>
											</div>
										</div>
                                        <div class="form-group row">
											...
											<div class="col-md-9 col-sm-9 ">
												<textarea class="form-control" rows="2" readonly="readonly"><?php echo $sl['pil_c']; ?></textarea>
											</div>
										</div>
                                        <div class="form-group row">
											...
											<div class="col-md-9 col-sm-9 ">
												<textarea class="form-control" rows="2" readonly="readonly"><?php echo $sl['pil_d']; ?></textarea>
											</div>
										</div>
                                        <div class="form-group row">
											...
											<div class="col-md-9 col-sm-9 ">
												<textarea class="form-control" rows="2" readonly="readonly"><?php echo $sl['pil_e']; ?></textarea>
											</div>
										</div>
                    <div class="form-group row">
											<label class="col-form-label col-md-3 col-sm-3 label-align ">Jawaban <span class="required">*</span>
											</label>
											<div class="col-md-9 col-sm-9 ">
												<textarea class="form-control" rows="2" readonly="readonly"><?php echo $sl['kunci']; ?></textarea>
											</div>
										</div>
