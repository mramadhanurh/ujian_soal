        ...
        <div class="right_col" role="main">
          <div class="">
            ...
            <div class="row">
                  ...
                  ?>
									<form method="post" action="edit_aksi_user.php" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Nama <span class="required">*</span>
											</label>
											<div class="col-md-6 col-sm-6 ">
                        <input type="hidden" name="id" value="<?php echo $ue['id']; ?>">
												<input type="text" name="nama" id="first-name" value="<?php echo $ue['nama']; ?>" class="form-control ">
											</div>
										</div>
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" name="username" id="last-name" value="<?php echo $ue['username']; ?>" class="form-control">
											</div>
										</div>
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
                        <input type="password" id="last-name" name="password" value="<?php echo $ue['password']; ?>" class="form-control">
											</div>
										</div>
										<div class="item form-group">
                      <label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">Level <span class="required">*</span>
											...
											<div class="col-md-6 col-sm-6 ">
												<select class="form-control" name="level" value="<?php echo $ue['level']; ?>">
													<option><?php echo $ue['level']; ?></option>
