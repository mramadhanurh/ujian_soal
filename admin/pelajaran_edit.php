          ...
          <div class="">
            ...
            <div class="row">
                   ...
                   <?php
                       include '../koneksi.php';
                       $id = $_GET['id'];
                       $hasil=mysqli_query($koneksi,"select * from pelajaran where id_pel='$id'");
                       while($p = mysqli_fetch_array($hasil)){
                  ?>
									<form method="post" action="edit_aksi_pelajaran.php" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Pelajaran <span class="required">*</span>
											</label>
											<div class="col-md-6 col-sm-6 ">
                                                <input type="hidden" name="id_pel" value="<?php echo $p['id_pel']; ?>">
												<input type="text" name="nama_pel" id="first-name" value="<?php echo $p['nama_pel']; ?>" class="form-control ">
											</div>
										</div>
										...
										<div class="item form-group">
											<div class="col-md-6 col-sm-6 offset-md-3">
												...
												<a href="pelajaran.php"><button class="btn btn-primary" type="button">Cancel</button></a>
											</div>
										</div>
