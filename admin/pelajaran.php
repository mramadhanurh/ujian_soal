          ...
          <div class="">
              ...
              <div class="title_right">
                <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
                  <div class="input-group">
                    <a href="pelajaran_tambah.php"><button class="fa fa-plus-square-o btn btn-primary float-right" type="button"> Tambah</button></a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Default Example <small>Pelajaran</small></h2>
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                      ...
                      <tbody>
                        <tr>
                          <td><?php echo $no++; ?></td>
                          <td><?php echo $p['nama_pel']?></td>
                          <td class="text-center">
                            <a href="pelajaran_edit.php?id=<?php echo $p['id_pel']; ?>" class="fa fa-pencil-square-o">Edit</a>
                            ||
                            <a href="delete_aksi_pelajaran.php?id=<?php echo $p['id_pel']; ?>" class="fa fa-trash">Hapus</a>
                          </td>
                        </tr>
                        <?php
                        }
