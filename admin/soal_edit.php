          ...
          <div class="">
            ...
            <div class="row">
                    ...
                    <?php
                        include '../koneksi.php';
                        $id = $_GET['id'];
                        $hasil=mysqli_query($koneksi,"select * from soal, pelajaran where soal.id_pel=pelajaran.id_pel and id_soal='$id'");
                        while($sl = mysqli_fetch_array($hasil)){
                    ?>
									<form method="post" action="edit_aksi_soal.php" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                                        <div class="form-group row">
											<label class="col-form-label col-md-3 col-sm-3 label-align ">Soal <span class="required">*</span>
											</label>
											<div class="col-md-9 col-sm-9 ">
                                                <input type="hidden" name="id_soal" value="<?php echo $sl['id_soal']; ?>">
												<textarea class="form-control" rows="7" name="soal"><?php echo $sl['soal']; ?></textarea>
											</div>
										</div>
                                        <div class="form-group row">
											<label class="col-form-label col-md-3 col-sm-3 label-align ">Pilihan A <span class="required">*</span>
											</label>
											<div class="col-md-9 col-sm-9 ">
												<textarea class="form-control" rows="2" name="pil_a" ><?php echo $sl['pil_a']; ?></textarea>
											</div>
										</div>
                                        <div class="form-group row">
											<label class="col-form-label col-md-3 col-sm-3 label-align ">Pilihan B <span class="required">*</span>
											</label>
											<div class="col-md-9 col-sm-9 ">
												<textarea class="form-control" rows="2" name="pil_b"><?php echo $sl['pil_b']; ?></textarea>
											</div>
										</div>
                                        <div class="form-group row">
											<label class="col-form-label col-md-3 col-sm-3 label-align ">Pilihan C <span class="required">*</span>
											</label>
											<div class="col-md-9 col-sm-9 ">
												<textarea class="form-control" rows="2" name="pil_c"><?php echo $sl['pil_c']; ?></textarea>
											</div>
										</div>
                                        <div class="form-group row">
											<label class="col-form-label col-md-3 col-sm-3 label-align ">Pilihan D <span class="required">*</span>
											</label>
											<div class="col-md-9 col-sm-9 ">
												<textarea class="form-control" rows="2" name="pil_d"><?php echo $sl['pil_d']; ?></textarea>
											</div>
										</div>
                                        <div class="form-group row">
											<label class="col-form-label col-md-3 col-sm-3 label-align ">Pilihan E <span class="required">*</span>
											</label>
											<div class="col-md-9 col-sm-9 ">
												<textarea class="form-control" rows="2" name="pil_e"><?php echo $sl['pil_e']; ?></textarea>
											</div>
										</div>
                    <div class="form-group row">
											<label class="col-form-label col-md-3 col-sm-3 label-align ">Pelajaran <span class="required">*</span>
											</label>
											<div class="col-md-9 col-sm-9 ">
                        <select class="form-control" name="id_pel">
                            <?php
                            echo "<option value=$sl[id_pel]> $sl[nama_pel] </option>";
                            $query = mysqli_query($koneksi, "select * from pelajaran");
                            ...
                            ?>
										...
										<div class="item form-group">
											<div class="col-md-6 col-sm-6 offset-md-3">
												...
												<a href="soal.php"><button class="btn btn-primary" type="button">Cancel</button></a>
											</div>
										</div>
